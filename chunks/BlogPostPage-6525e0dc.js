import{i as t,x as s,o as e}from"./vendor-7603fedf.js";import{a}from"./blog-6615a199.js";import"../index-0d82a843.js";let i;class o extends t{static properties={slug:{type:String},post:{type:Object},isLoading:{type:Boolean},errorMessage:{type:String}};constructor(){super(),this.slug="",this.post=null,this.isLoading=!0,this.errorMessage="",this._lastLoadedSlug="",this._renderedMarkdown="",this._loadToken=0}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this._loadPost()}updated(t){t.has("slug")&&this._loadPost()}async _loadPost(){if(!this.slug||this.slug===this._lastLoadedSlug)return;this.isLoading=!0,this.errorMessage="";const t=++this._loadToken;try{const[s,{marked:e,DOMPurify:o}]=await Promise.all([a(this.slug),(i||(i=Promise.all([import("./markdown-a8e5d18f.js").then((function(t){return t.m})),import("./markdown-a8e5d18f.js").then((function(t){return t.p}))]).then((([{marked:t},{default:s}])=>({marked:t,DOMPurify:s})))),i)]);if(t!==this._loadToken)return;this.post=s;const n=e.parse(s.markdown||"");this._renderedMarkdown=o.sanitize(n),this._lastLoadedSlug=this.slug}catch(s){if(t!==this._loadToken)return;this.post=null,this._renderedMarkdown="",this.errorMessage="Could not load this blog post."}finally{t===this._loadToken&&(this.isLoading=!1)}}render(){return this.isLoading?s`
